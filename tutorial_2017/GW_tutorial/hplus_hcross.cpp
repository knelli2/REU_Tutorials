...
// to compile and run:
// g++ -O2 -fopenmp -lfftw3 DataFile.cpp hplus_hcross.cpp -o hplus_hcross && ./hplus_hcross
...
int main (int argc, const char *argv[])
{
   ...
   calc_Clm("Psi4.mon.sort.6",  77.9258507826028, 0.989786); //TODO (filename, radius, ADM mass)
   
   cout << "3D test...\n";
   write_3D("3D",n,n,n/2,-max,max,-max,max,-max,0,1);
   //write_1D("1D.csv", 3.141592654/6.0, 0.0);
