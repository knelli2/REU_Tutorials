...
# TODO: Put the additional database into dbs list when you add a new database. 
dbs = [rho_bdir]
if fields():
...
#trace_idx = 1
#if particles():
#	gridPoints_idx += 1; bh_idx += 1; trace_idx += 1;
#if gridPoints():
#	bh_idx += 1; trace_idx += 1;
#if bh_formed():
#	trace_idx += 1; bh_merged_idx += 1;
#if binary_formed():
#	trace_idx += 1; bh_merged_idx += 1;
#if merge_formed():
#	trace_idx += 1;

# TODO: Put the plot name into plot_idx list when you add a new plot.
plot_idx = ["density"]
if particles():
	plot_idx += ["particles"]
if gridPoints():
